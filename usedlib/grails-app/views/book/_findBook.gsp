...
<!-- 			<div class="table">
				...
				<g:if test="${params.controller=="book"&&params.action=="index"}">
				...
				<g:else>
					<g:if test="${(booksCount>params.offset)||(flash.bookTotalTemp!=null)}">				
						<g:remoteLink controller="book" action="findBook" update="divContactList" params="[max:params.max,offset:params.offset]">更多...</g:remoteLink>
					</g:if>
				</g:else>